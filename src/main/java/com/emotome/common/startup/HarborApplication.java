 ...
 * the License.
 ******************************************************************************/
package com.emotome.common.startup;
...
@SpringBootApplication(scanBasePackages = { "com.emotome" }, exclude = { HibernateJpaAutoConfiguration.class })
...
public class HarborApplication extends SpringBootServletInitializer {
	...
	protected SpringApplicationBuilder configure(SpringApplicationBuilder springApplicationBuilder) {
		return springApplicationBuilder.sources(HarborApplication.class);
	}
